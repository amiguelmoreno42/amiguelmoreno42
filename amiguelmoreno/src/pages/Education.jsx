      ...
      <div className="container">
        <div className="degree">
          <div className="degree-header">
            ...
            <div className="icon">
              <i onClick={hideShow} className="plus-icon fa-solid fa-plus"></i>
              <i
                onClick={hideShow}
          ...
          <div className="degree-description">
            <div className="degree-description-info">
              <ul>
                <li>
                  How to plan, sketch, design, build, test, and optimize a
                  professional website
                </li>
                <li>
                  Modern CSS (previous CSS3), including flexbox and CSS Grid for
                  layout
                </li>
                <li>
                  Modern CSS (previous CSS3), including flexbox and CSS Grid for
                ...
                <li>
                  Developer skills such as reading documentation, debugging, and
