export const educationInfo = [
  {
    ...
    imageInstitution:
      import.meta.env.BASE_URL + "../../education/logos/platzi-logo.png",
    imageEducation:
      import.meta.env.BASE_URL + "../../education/covers/platzi.png",
  },
  {
    id: 2,
    ...
    duration: "38 hours",
    certification:
      "https://www.udemy.com/certificate/UC-bfefdf28-d891-4acd-b7ac-2804b687d59c/",
    description:
      "Learn how to make stunning websites with modern HTML5, CSS3 and web design.",
    skills: [
    ...
    imageEducation:
      import.meta.env.BASE_URL + "../../education/covers/html-css.png",
  },
  {
    id: 3,
    ...
    duration: "28 hours",
    certification:
      "https://www.udemy.com/certificate/UC-3ca936d7-92bf-45df-b580-b835049d442e/",
    description:
      "Learn how to use the most advanced and modern CSS, mastering flexbox, CSS Grid, responsive design and more.",
    skills: [
    ...
    imageInstitution:
      import.meta.env.BASE_URL + "../../education/logos/udemy-logo.svg.png",
    imageEducation:
      import.meta.env.BASE_URL + "../../education/covers/css-sass.png",
  },

  {
    ...
    duration: "69 hours",
    certification:
      "https://www.udemy.com/certificate/UC-26c7140b-6041-4aac-afd2-6cb8b1bc0f79/",
    description:
    ...
    imageInstitution:
      import.meta.env.BASE_URL + "../../education/logos/udemy-logo.svg.png",
    imageEducation:
      import.meta.env.BASE_URL + "../../education/covers/javascript.png",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    duration: "17 hours",
    certification:
      "https://www.udemy.com/certificate/UC-e8a35d61-e4e5-42c5-baff-ea219a30f899/",
    description:
  ...
  },
  {
    ...
    skills: [
      ...
      "Advanced Programming: I've gained advanced knowledge in programming, covering key topics and concepts for software development.",
      ...
      "Technological Community: The experience at 42 Málaga has connected me with a vibrant technological community, providing networking opportunities and continuous learning.",
      ...
      "Code Optimization: I've perfected code optimization techniques to create efficient and high-performance solutions.",
      "Emphasis on Best Practices: 42 Málaga has instilled the importance of following best development practices, such as version control usage and effective documentation.",
    ],
    imageInstitution:
      import.meta.env.BASE_URL + "../../education/logos/42Malaga-logo.png",
    imageEducation:
  ...
  },
  {
    ...
    duration: "67 hours",
    certification:
      "https://www.udemy.com/certificate/UC-9313b7cb-2d4b-4aad-9276-f97e3221682d/",
    description:
      "Explore the world of modern React, progressing from beginner to advanced levels. Covering the Context API, React Query, Redux Toolkit, Tailwind, advanced patterns, and beyond.",
    skills: [
