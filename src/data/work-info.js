export const workInfo = [
  {
    ...
    imageCompany:
      import.meta.env.BASE_URL + "../../work/logos/grupo-uno-asesores.png",
  },
  {
    id: 2,
    ...
    duration: "6 months",
    description:
      "In my role as an administrative professional, I gained valuable experience during my regular job. I contributed to essential administrative tasks, collaborated closely with professionals in the field, and enhanced my skills in a practical work environment, complementing my academic background.",
    skills: [
      ...
      "Delivered exceptional customer service, consistently exceeding expectations and fostering positive client relationships.",
    ],
