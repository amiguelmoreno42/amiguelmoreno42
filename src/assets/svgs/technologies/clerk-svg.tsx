export default function clerkSvg({ width = 40, height = 40, fill = 'none' }) {
	return (
		<svg
			width={width}
			height={height}
		...
		>
			<defs>
				<linearGradient x1="84.775%" y1="-9.121%" x2="-40.08%" y2="116.867%" id="a">
					<stop stop-color="#17CCFC" offset="0%"></stop>
					<stop stop-color="#5D31FF" offset="50%"></stop>
					<stop stop-color="#F35AFF" offset="100%"></stop>
				</linearGradient>
			</defs>
			<g fill="none">
