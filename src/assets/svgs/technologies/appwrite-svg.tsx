export default function appwriteSvg({ width = 40, height = 40, fill = 'none' }) {
	return (
		<svg
			...
			height={height}
			fill={fill}
			className="u-max-width-100-percent"
			viewBox="0 0 112 98"
		>
			<path
				fill="#FD366E"
			...
			<path
				fill="#FD366E"
				d="M111.1 42.303v24.49H65.676a24.406 24.406 0 0 0 7.686-17.81c0-2.316-.321-4.556-.922-6.68z"
			></path>
		</svg>
	)
}
